...
#define PUSHBTN_TMR_PERIOD		30
// Criteria for determination of short click and long click
#define PUSHBTN_TO_SHORT		3		// 3 * PUSHBTN_TMR_PERIOD  90
#define PUSHBTN_TO_LONG			10		// 10 * PUSHBTN_TMR_PERIOD 300
